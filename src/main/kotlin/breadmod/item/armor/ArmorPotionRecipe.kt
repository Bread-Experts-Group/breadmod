...
import breadmod.recipes.ModRecipes.ARMOR_POTIONS
...
class ArmorPotionRecipe(pId: ResourceLocation) : CustomRecipe(pId) {
    ...
    override fun getSerializer(): RecipeSerializer<ArmorPotionRecipe> = ARMOR_POTIONS
}