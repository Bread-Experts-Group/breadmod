...
object ModMenuTypes {
    internal val deferredRegister: DeferredRegister<MenuType<*>> =
        DeferredRegister.create(ForgeRegistries.MENU_TYPES, ModMain.ID)
    ...
    val TOOL_GUN_CREATOR: RegistryObject<MenuType<ToolGunCreatorMenu>> =
        deferredRegister.register("tool_gun_creator_menu") {
