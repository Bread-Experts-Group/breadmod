...
//        threeByThreePacker(pWriter, RecipeCategory.BUILDING_BLOCKS, ModBlocks.BREAD_BLOCK.get(), Items.BREAD)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.WRENCH.get())
            ...
            .pattern("BIO")
            .pattern("I  ")
            .save(pWriter, modLocation("tools", "wrench"))
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.WRENCH.get())
            .unlockedBy("has_item", has(Items.IRON_INGOT))
            .define('I', Items.IRON_INGOT)
            .define('O', Items.ORANGE_DYE)
            ...
            .pattern("OIB")
            .pattern("  I")
            .save(pWriter, modLocation("tools", "wrench_alt"))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.RICARD_BLOCK.get())
            ...
            .pattern("BPR")
            .pattern("BWW")
            .save(pWriter, modLocation("decorations", "characters", "ricard_block"))
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.UNFUNNYLAD_BLOCK.get())
            ...
            .pattern("SBS")
            .pattern(" B ")
            .save(pWriter, modLocation("decorations", "characters", "unfunnylad_block"))
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.OMANEKO_BLOCK.get())
            ...
            .pattern("BGB")
            .pattern("bBb")
            .save(pWriter, modLocation("decorations", "characters", "omaneko_block"))
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.NIKO_BLOCK.get())
            ...
            .pattern("RWG")
            .pattern("BRB")
            .save(pWriter, modLocation("decorations", "characters", "niko_block"))
