...
typealias biomeBuilder = (
	HolderGetter<PlacedFeature>,
	HolderGetter<ConfiguredWorldCarver<*>>,
	HolderGetter<SoundEvent>
) -> Biome
...
object ModBiomes {
	...
	fun bootstrapBiomes(ctx : BootstrapContext<Biome>) {
		...
		this.entries.forEach { ctx.register(it.first, it.second(features, carvers, sound)) }
	}
}