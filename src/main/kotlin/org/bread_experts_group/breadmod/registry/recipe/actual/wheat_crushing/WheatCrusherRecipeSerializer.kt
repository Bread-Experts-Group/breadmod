...
class WheatCrusherRecipeSerializer : RecipeSerializer<WheatCrusherRecipe> {
	...
	override fun codec() : MapCodec<WheatCrusherRecipe> = this.codec
	override fun streamCodec() : StreamCodec<RegistryFriendlyByteBuf, WheatCrusherRecipe> = this.streamCodec
}