...
import org.bread_experts_group.breadmod.datagen.damage_type.DataGenerateDamageType
...
data class ModDamageType(val key: ResourceKey<DamageType>) {
	...
	companion object {
		@DataGenerateDamageType
		@DataGenerateLanguage("en_us", "%1\$s ran out of time!")
		val TIMER_RAN_OUT: ModDamageType = ModDamageType("timer")

		@DataGenerateDamageType(damageEffect = DataGenerateDamageType.IncomingDamageEffect.BURNING)
