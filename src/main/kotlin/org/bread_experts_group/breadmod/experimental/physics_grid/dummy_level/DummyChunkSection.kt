...
class DummyChunkSection(private val chunk: DummyChunk, private val yStart: Int) : LevelChunkSection(
	chunk.level.registryAccess().registryOrThrow(Registries.BIOME)
) {
	...
	override fun getBlockState(x: Int, y: Int, z: Int): BlockState =
		this.chunk.level.getBlockState(BlockPos(x + this.xStart, y + this.yStart, z + this.zStart))
