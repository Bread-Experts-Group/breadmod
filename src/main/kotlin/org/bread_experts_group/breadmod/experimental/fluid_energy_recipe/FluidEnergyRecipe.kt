...
abstract class FluidEnergyRecipe(
    ...
    override fun assemble(input: FluidEnergyInput, registries: HolderLookup.Provider): ItemStack = this.rItemOutputs[0]
    ...
    class FluidEnergySerializer<R : FluidEnergyRecipe>(
        val recipe: Function6<NonNullList<SizedIngredient>, MutableList<ItemStack>, NonNullList<SizedFluidIngredient>, MutableList<FluidStack>, Int?, Int?, R>
    ...
    class FluidEnergyBuilder(
        private val recipe: (NonNullList<SizedIngredient>, MutableList<ItemStack>, NonNullList<SizedFluidIngredient>, MutableList<FluidStack>, Int?, Int?) -> FluidEnergyRecipe,
