...
@Mod.EventBusSubscriber(modid = ModMain.Companion.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
object Config {
    ...
    /*private val ITEM_STRINGS: ForgeConfigSpec.ConfigValue<List<String>> = BUILDER
        ...
        .defineListAllowEmpty("items", listOf("minecraft:iron_ingot")) { obj: Any? -> validateItemName() }*/
